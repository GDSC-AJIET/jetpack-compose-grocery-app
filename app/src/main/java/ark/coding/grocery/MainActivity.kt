        ...
        Row(
            ...
            Row(Modifier
                ...
                Column(Modifier.padding(8.dp)) {
                    Text(text = "SAVE MONEY", fontWeight = FontWeight.Bold, fontSize = 12.sp)
                    Text(text = "With splendid discounts", color = MaterialTheme.colors.primary, fontSize = 10.sp)
                }
            }
            ...
            Row(Modifier
                ...
                Icon(painter = painterResource(id = R.drawable.rupees_save), contentDescription = "", tint = MaterialTheme.colors.primary)
                Column(Modifier.padding(8.dp)) {
                    Text(text = "Buy Items of ₹25", fontWeight = FontWeight.Bold, fontSize = 12.sp)
                    Text(text = "And get reward points", color = MaterialTheme.colors.primary, fontSize = 10.sp)
                }
            }
        }
    }
...
fun Promotions() {
    LazyRow(
        ...
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.veg_ico2),
                title = "Fruit",
                subtitle = "Start @",
                header = "₹1",
                backgroundColor = Color(0x7E02EE1A)
            )
        }
        item {
            PromotionItem(
                imagePainter = painterResource(id = R.drawable.meatp),
                title = "Meat",
                subtitle = "Discount",
                header = "20%",
...
fun BestSellerItems() {
    LazyRow(
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.coria),
                title = "Coriander",
                price = "1.99",
                discountPercent = 10
            )
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.appul),
                title = "Apple",
                price = "2.64",
                discountPercent = 5
            )
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.meetmeet),
                title = "Meat",
                price = "4.76",
                discountPercent = 20
            )
        ...
        item {
            BestSellerItem(
                imagePainter = painterResource(id = R.drawable.ghee),
                title = "Ghee",
                price = "2.64",
                discountPercent = 5
            )
